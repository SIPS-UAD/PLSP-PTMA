        ...
        <div className="grid gap-4 md:grid-cols-2">
          <Card>
            ...
            <CardContent className="flex flex-col items-center justify-center space-y-4 text-center">
              ...
              <p className="text-sm text-muted-foreground">
                Buat dan publikasikan postingan baru
              </p>
          ...
          <Card>
            ...
            <CardContent className="flex flex-col items-center justify-center space-y-4 text-center">
              ...
              <p className="text-sm text-muted-foreground">
                Jadwalkan dan kelola event baru
              </p>
        ...
        <div className="rounded-lg border">
                    ...
                    <span
                      className={`inline-flex items-center rounded-md px-2 py-1 text-xs font-medium ${
                        item.type === 'post'
                          ...
                          : 'bg-green-50 text-green-700 ring-1 ring-green-600/10 ring-inset'
                      }`}
                    >
                      {item.type === 'post' ? 'Postingan' : 'Event'}
                    </span>
                  </TableCell>
          ...
          <div className="flex items-center justify-between px-4 py-4">
            <p className="text-sm text-muted-foreground">
              ...
              {Math.min(endIndex, combinedItems.length)} dari{' '}
              {combinedItems.length} entri
            </p>
            <div className="flex items-center space-x-2">
              <Button
                variant="outline"
